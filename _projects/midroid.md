...
{% cite conf/rv/FalconeCJ12 %},
{% cite conf/kbse/FalconeC12 %},
{% cite conf/isola/El-HarakeFJLM14 %},
{% cite conf/rv/DaianFMSSIR15 %},
{% cite journals/sttt/JaberFDAE18 %}.
...
<div style="display: flex; justify-content: center; gap: 20px; margin-top: 50px;">
    <img 
      src="../assets/img/midroid1.png" 
      alt="MiDroid screen capture 1" 
      title="MiDroid screen capture 1"
      style="width: 250px; display: block; border: 1px solid #ccc; border-radius: 4px;"
    />
    <img 
      src="../assets/img/midroid1.png" 
      alt="MiDroid screen capture 1" 
      title="MiDroid screen capture 2"
